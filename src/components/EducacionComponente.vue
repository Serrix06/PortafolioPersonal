...
const educacion = ref([
  {fecha: '2023', title: 'Finalice el colegio Secundario', descripcion: "En Noviembre del año 2023 termine mis estudios en el colegio secundario 'Sagrado Corazon de Jesus'."},
  {fecha: '2024', title: 'Técnicatura Universitaria en Programacion', descripcion: 'Estudio la carrera de Tecnico Universitario en Programacion en la Cohorte 2024'},]);
</script>
